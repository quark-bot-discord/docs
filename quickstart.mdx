...
<Accordion icon="branch" title="Redirect logs to different channels">
...
<Accordion icon="message-bot" title="Bot integrations">
  Quark is designed to be compatible with other bots! This is why Quark provides the option for
  native [PluralKit](https://pluralkit.me) to prevent Quark's logs from being rendered useless.
