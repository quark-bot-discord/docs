import { ReactComponent as QuarkIcon } from '../images/quark.svg';
import { ReactComponent as QuarkProIcon } from '../images/quarkPro.svg';
...
<AccordionGroup>
  <Accordion title="Quark" icon={<QuarkIcon />} defaultOpen="true">
    ```
    from: Quark Logger#8645 USER_ID_HERE
    ```
  </Accordion>

  <Accordion title="Quark Pro" icon={<QuarkProIcon />}>
    ```
