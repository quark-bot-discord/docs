...
<a href="http://languages.quark.bot/engage/quark-bot/">
<img src="http://languages.quark.bot/widget/quark-bot/multi-auto.svg" alt="Translation status" />
</a>
...
add a new language, you can do so by visiting the [Start Translating guide](/languages/start-translating)!
...
<CardGroup cols={2}>
    <Card title="Start translating" icon="language" href="/languages/start-translating">
        View our guide on how to start translating Quark's language files.
    </Card>
    <Card title="Add a new language" icon="plus" href="/languages/add-language">
        View our guide on how to add a new language to Quark.
    </Card>
</CardGroup>